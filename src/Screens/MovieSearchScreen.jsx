...
const SearchMovies = (props) => {
  // console.log('SearchMovies props:', props);
  const { query, type, flag } = props.route.params;
  console.log(query);
  const { movie } = useContext(ContextApi).genres;
  console.log(movie);
  const url = flag === 'bar' ? getMultiSearchUrl('movie', query) : getTmdbGenreUrl('discover/movie', movie[query]);
  console.log(url);
  ...
  const RenderItem = ({ item }) => (
    <Pressable onPress={() => props.navigation.navigate('MovieDetail', { id: item.id })}>
